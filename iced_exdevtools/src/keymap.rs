...
pub fn key(key: winit_core::keyboard::Key) -> crate::core::keyboard::Key {
    use crate::core::keyboard;
    use crate::core::keyboard::key::Named;
    use winit_core::keyboard::NamedKey;

    match key {
        winit_core::keyboard::Key::Character(c) if c == " " => keyboard::Key::Named(Named::Space),
        winit_core::keyboard::Key::Character(c) => {
            keyboard::Key::Character(crate::core::SmolStr::from(c.to_string()))
        }
        // Hyper and Super are deprecated
        #[allow(deprecated)]
        winit_core::keyboard::Key::Named(named_key) => keyboard::Key::Named(match named_key {
...
pub fn modifiers(modifiers: ModifiersState) -> crate::core::keyboard::Modifiers {
    use crate::core::keyboard;
...
pub fn physical_key(
    physical_key: winit_core::keyboard::PhysicalKey,
) -> crate::core::keyboard::key::Physical {
    use crate::core::keyboard;
    match physical_key {
        winit_core::keyboard::PhysicalKey::Code(code) => {
        ...
        winit_core::keyboard::PhysicalKey::Unidentified(code) => {
...
/// [`winit`]: https://github.com/rust-windowing/winit
/// [`iced`]: https://github.com/iced-rs/iced/tree/0.12
pub fn key_code(key_code: winit_core::keyboard::KeyCode) -> Option<keyboard::key::Code> {
    use winit_core::keyboard::KeyCode;
...
pub fn native_key_code(
    native_key_code: winit_core::keyboard::NativeKeyCode,
